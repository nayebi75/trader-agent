...
public class StrategyService {
    ...
    public record AnalysisResult(Boolean hasBuySignal, BigDecimal tp, BigDecimal sl) {
    }
    ...
    private AnalysisResult analyzeSeries(BarSeries series) {
        ...
        AnalysisResult analysisResult = new AnalysisResult(false, null, null);
        ...
        if (hasBuySignal) {
            ...
            if (riskRewardIsValidated)
                analysisResult = new AnalysisResult(true, takeProfit, stopLoss);
        }
    ...
    private AnalysisResult getAnalysisResult(String symbol) {
    ...
    public AnalysisResult cryptoCurrencyAnalysisResult(String cryptoCurrency) {
        return getAnalysisResult(cryptoCurrency);
    }
